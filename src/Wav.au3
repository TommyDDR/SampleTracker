...
; ---------------------------------------------------------------------------
; Lecture d'en-tête WAV (RIFF/WAVE) : format et durée, sans charger les données.
; Aucune dépendance UI : module testable en CLI.
; ---------------------------------------------------------------------------

; Parcourt les chunks RIFF. Retourne la durée en secondes, renseigne
; $iRate / $iChannels / $iBits par référence.
